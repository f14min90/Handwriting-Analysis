...
public class Service
{
    ...
    public static void Send_mail(string to, string code)
    {
        ...
        using(SmtpClient smtp = new SmtpClient())
        {
            ...
            smtp.Credentials = new NetworkCredential("hwanalysis@dsoft.ru", "pass");
    ...
    {        
        ...
        string path = @"C:\sites\ru.dsoft.hwa\Temp\" + guid + ".bmp";      
        ...
        using (Process process = new Process())
        {
            ProcessStartInfo info = new ProcessStartInfo
            {
                ...
                Arguments = @"C:\sites\ru.dsoft.hwa\neuronet\go.py " + path
            };           
        ...
        File.Delete(path);
        if (answer == "None" || string.IsNullOrEmpty(answer)) throw new Exception(answer);
