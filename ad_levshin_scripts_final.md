...
## **[Сценарий 5 - Поиск пользователей с похожим почерком по базе данных ]**
  1. Пользователь переходит в раздел **Поиск**
  2. Нажимает кнопку **найти**, и спустя некоторое время сервер выдаёт список почт других пользователей.
